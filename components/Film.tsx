            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-[22px]">
                <motion.button
                  ...
                  onClick={handlePlay}
                  className="flex h-[78px] w-[78px] cursor-pointer items-center justify-center rounded-full border border-cream/50 bg-cream/10 backdrop-blur-[6px] transition-colors hover:bg-cream/20"
                >
